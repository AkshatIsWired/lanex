...
The M5 wizard offers four presets: recommended, maximum, custom, and deliberate minimal profiles.
Recommended provides the complete everyday toolchain with SKY130A starter libraries; maximum installs
all supported tools and PDKs; custom exposes both engines, independent PDK choices, and advanced libraries.
The same manifest-bound planner validates `/PROFILE` or `/SELECTIONS` unattended input
